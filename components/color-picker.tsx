        ...
        const styles = reactCSS({
            'default': {
                color: {
                    ...
                    height: '14px',
                    borderRadius: '2px',
                    background: !this.state.random && `rgba(${this.state.color.r}, ${this.state.color.g}, ${this.state.color.b}, ${this.state.color.a})`,
                },
                swatch: {
                    padding: '5px',
                    background: '#fff',
        ...
        return (
            <div>
                <div style={styles.swatch} onClick={this.handleClick}>
                    {!this.state.random ? <div style={styles.color}/> :
                        <div><GiPerspectiveDiceSixFacesRandom size={25}/></div>}
                </div>
